    ...
    <div className="bg-white rounded-2xl shadow-sm border border-gray-100">
      <div className="p-6 border-b border-gray-100">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            <h2 className="text-xl font-semibold text-gray-900">Worker Management</h2>
            <p className="text-gray-600 mt-1">Manage workers for {agencyName}</p>
      ...
      <div className="p-6 border-b border-gray-100 bg-blue-50">
        <div className="flex items-center justify-between">
          <div>
            <h3 className="text-sm font-medium text-gray-700 mb-1">Agency ID</h3>
            <p className="text-lg font-mono text-blue-900 bg-white px-3 py-2 rounded border">
              {agencyId}
            </p>
            <p className="text-xs text-gray-500 mt-1">Share this ID with workers for login</p>
          </div>
          <button
      ...
      <div className="p-6">
        {workers.length === 0 ? (
          <div className="text-center py-12">
            ...
            <p className="text-gray-600 mb-4">Start by adding your first worker to manage orders.</p>
          </div>
        ) : (
            ...
            {workers.map((worker) => (
              <div key={worker.id} className="border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow">
                ...
                <div className="space-y-2">
                  <div>
                    <label className="text-xs font-medium text-gray-500">Worker ID</label>
                    <div className="flex items-center gap-2">
          ...
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md">
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-4">
              <div>
                ...
                <div className="w-full px-3 py-2 border border-gray-300 rounded-lg bg-gray-100 text-gray-700 font-mono text-sm">
                  {agencyId}
                </div>
                <p className="text-xs text-gray-500 mt-1">Worker will use this ID to login</p>
              </div>
              ...
              <div className="bg-blue-50 p-3 rounded-lg">
                <h4 className="text-sm font-medium text-blue-900 mb-2">Login Instructions for Worker:</h4>
